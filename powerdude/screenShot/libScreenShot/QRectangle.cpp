...
QRectangle::QRectangle(QPoint startPoint, DrawableProperty pro, QObject *parent)
	: IDrawable(DrawableType::RectangleObj,pro,parent),
...
void QRectangle::Draw(QPainter& painter)
{
	if (m_bCanDrawed) {
		painter.save();
		QPen pen;
...
void QRectangle::setEndPoint(QPoint endPoint)
{
	m_endPoint = endPoint;
